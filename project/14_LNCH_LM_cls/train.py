...
def train():
    ...
    # Train the model
    results = model.train(data=r"E:\Data\TrainSet\14_LNCH_LM_cls\1104_a1.7b15\images",
                          cfg=r"project\14_LNCH_LM_cls\cfg.yaml",
                          epochs=150, imgsz=320, batch=16, close_mosaic=15,
                          name=r"14_LNCH_LM_cls\1104_e150_i320_b16")
