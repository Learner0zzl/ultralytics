...
def train():
    ...
    # Train the model
    results = model.train(data=r"project\34_GGJ_Cu_det\dataset.yaml",
                          cfg=r"project\34_GGJ_Cu_det\cfg.yaml",
                          epochs=150, imgsz=320, batch=16, close_mosaic=15,
                          project=r"E:\Git\ultralytics\runs\detect\34_GGJ_Cu_det",
                          name=r"0417_e150_i320_b16_all")
