...
if __name__ == '__main__':
    ...
    for cls in os.listdir(root_dir):
        print(f"process cls={cls}")
        img_dir = osp.join(root_dir, cls)
        img_paths = find_files_by_ext(img_dir, '.bmp', mode="dict", func=lambda f: osp.splitext(f)[0])
        ...
        dst_dir = rf"{root_dir}_C5_{model_name}_analysis_cls{cls}"
