...
def train():
    ...
    # Train the model
    results = model.train(data=r"E:\Data\TrainSet\30_LF_CuO_cls\0326\images",
                          cfg=r"project\30_LF_CuO_cls\cfg.yaml",
                          epochs=100, imgsz=320, batch=16, close_mosaic=15,
                          name=r"30_LF_CuO_cls\0326_e100_i320_b16")
