...
def train():
    ...
    # Train the model
    results = model.train(data=r"E:\Data\TrainSet\13_HS_CaF2_cls\1029_a1b8\images",
                          cfg=r"project\13_HS_CaF2_cls\cfg.yaml",
                          epochs=150, imgsz=320, batch=16, close_mosaic=15,
                          name=r"13_HS_CaF2_cls\1029_e150_i320_b16")
