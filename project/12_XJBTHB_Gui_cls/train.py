...
def train():
    ...
    # Train the model
    results = model.train(data=r"E:\Data\TrainSet\12_XJBTHB_Gui_cls\1028\images",
                          cfg=r"project\12_XJBTHB_Gui_cls\cfg.yaml",
                          epochs=150, imgsz=320, batch=16, close_mosaic=15,
                          name=r"12_XJBTHB_Gui_cls\1028_e150_i320_b16")
