...
def train():
    ...
    # Train the model
    results = model.train(data=r"E:\Data\TrainSet\29_DFXW_CaCO3_cls\0326\images",
                          cfg=r"project\29_DFXW_CaCO3_cls\cfg.yaml",
                          epochs=150, imgsz=320, batch=16, close_mosaic=15,
                          name=r"29_DFXW_CaCO3_cls\0326_e150_i320_b16")
