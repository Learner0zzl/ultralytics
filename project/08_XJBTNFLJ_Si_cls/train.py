...
def train():
    ...
    # Train the model
    results = model.train(data=r"E:\Data\TrainSet\08_XJBTNFLJ_Si_cls\0424_a1b12\images",
                          cfg=r"project\08_XJBTNFLJ_Si_cls\cfg.yaml",
                          epochs=150, imgsz=320, batch=16, close_mosaic=10,
                          name=r"08_XJBTNFLJ_Si_cls\0424_e150_i320_b16")
