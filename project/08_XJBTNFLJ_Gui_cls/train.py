...
def train():
    ...
    # Train the model
    results = model.train(data=r"E:\Data\TrainSet\08_XJBTNFLJ_Gui_cls\images",
                          cfg=r"project\08_XJBTNFLJ_Gui_cls\cfg.yaml",
                          epochs=100, imgsz=320, batch=16, close_mosaic=10,
                          name=r"08_XJBTNFLJ_Gui_cls\1021_e100_i320_b16")
