...
def train():
    ...
    # Train the model
    results = model.train(data=r"E:\Data\TrainSet\07_TRQ_Lv_cls\1205_a1.3b12\images",
                          cfg=r"project\07_TRQ_Lv_cls\cfg.yaml",
                          epochs=100, imgsz=160, batch=16, close_mosaic=10,
                          name=r"07_TRQ_Lv_cls\1205_e100_i160_b16")
